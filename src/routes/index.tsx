          ...
          <div className='flex items-center justify-between py-2 sm:py-3'>
            ...
            <div className='flex items-center gap-1.5 sm:gap-2 md:gap-3 ml-2 flex-shrink-0'>
              ...
              <a
                ...
                className='hidden sm:flex items-center gap-1 sm:gap-2 md:gap-3 px-3 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 border-2 border-gray-300 rounded hover:border-[#7FB77E] hover:bg-[#F0F8F3] transition-all duration-300 group'
              >
                <svg className='w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 flex-shrink-0' fill='#7FB77E' viewBox='0 0 20 20'>
                  <path d='M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z' />
                </svg>
                <div className='hidden md:block text-left'>
                  <div className='text-sm md:text-base font-bold text-gray-900 group-hover:text-[#7FB77E]'>Call</div>
                  <div className='text-[10px] md:text-xs text-gray-500'>08043880537</div>
                </div>
              </a>
